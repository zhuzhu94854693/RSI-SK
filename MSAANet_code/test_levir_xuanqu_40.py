...
def test(loader, num_classes, device, net):
    ...
    result_folder = r'/home/user/zly/data2/WHU_clip/result/MSAANet/t0.40'
...
if __name__ == '__main__':
    ...
    net = torch.load(r"/home/user/zly/data2/WHU_clip/pth/MSAANet/t0.40/model_best.pth")
    ...
    logger = get_log('/home/user/zly/data2/WHU_clip/result/MSAANet/MSAANet_t0.40_test.txt')
