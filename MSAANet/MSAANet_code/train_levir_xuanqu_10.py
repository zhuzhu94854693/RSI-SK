...
device = 'cuda'
path = r'/home/user/zly/data2/WHU_clip/sample/t0.10/'
...
if __name__ == '__main__':
    ...
    logger = get_log("MSAANet" + 't0.10_train_log.txt')
    ...
    for epoch in range(num_epochs):
        ...
        if f1score > best_f1:
            ...
            checkpoint = os.path.join(
                # r'/home/user/zly/data2/WHU_clip/pth/MSAANet/t0.10/','model{}_{}_{}_best.pth'.format(model_name, f1score,epoch)
                r'/home/user/zly/data2/WHU_clip/pth/MSAANet/t0.10/model_best.pth'
            )
